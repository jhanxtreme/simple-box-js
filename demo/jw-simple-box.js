		...
		function images(){
			...
			var loadModalElements = function(){
				...
				if($(settings.modal.ModalOuter).length == 0){
					$('<div class="jw-simple-box transparent" id="jw-simple-box"><div class="loading spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div><div class="jw-simple-box-inner" id="jw-simple-box-inner"></div></div>').prependTo('body');
